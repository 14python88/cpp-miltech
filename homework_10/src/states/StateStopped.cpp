...
#include <memory>
    ...
    std::unique_ptr<IDroneState> StateStopped::execute(DroneConfig& config, DroneTelemetry ctx, PrefParameters& prefParams, float& acceleration, float& t_acceleration) {
